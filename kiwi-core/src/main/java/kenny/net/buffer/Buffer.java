...
/**
 * Created by kennylbj on 16/9/22.
 */
public interface Buffer extends Comparable<Buffer> {

    /**
     * Returns the factory which creates a {@link Buffer} whose
     ...
     * {@link Buffer} buf = {@link Buffer}.buffer(8);
     *
     ...
     * {@link Buffer} buf = {@link Buffer}.wrappedBuffer(new byte[8]);
     *
     ...
     *            {@code this.capacity}
     */
    void getBytes(int index, Buffer dst);
     ...
     */
    void getBytes(int index, Buffer dst, int length);
     ...
     *            {@code dst.capacity}
     */
    void getBytes(int index, Buffer dst, int dstIndex, int length);
     ...
     */
    void setBytes(int index, Buffer src, int length);
     ...
     *            {@code src.capacity}
     */
    void setBytes(int index, Buffer src, int srcIndex, int length);
     ...
     *         if {@code length} is greater than {@code dst.writableBytes}
     */
    void readBytes(Buffer dst, int length);
     ...
     *            {@code dst.capacity}
     */
    void readBytes(Buffer dst, int dstIndex, int length);
     ...
     */
    void writeBytes(Buffer src, int length);
     ...
     */
    void writeBytes(Buffer src, int srcIndex, int length);
     ...
     */
    int indexOf(int fromIndex, int toIndex, BufferIndexFinder indexFinder);
     ...
     */
    int bytesBefore(BufferIndexFinder indexFinder);
     ...
     *         if {@code length} is greater than {@code this.readableBytes}
     */
    int bytesBefore(int length, BufferIndexFinder indexFinder);
     ...
     *         if {@code index + length} is greater than {@code this.capacity}
     */
    int bytesBefore(int index, int length, BufferIndexFinder indexFinder);
